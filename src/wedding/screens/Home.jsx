...
export default function Home() {
  ...
  return (
    <div className="wedding-fade">
      ...
      <div style={{ maxWidth: 1500, margin: 'clamp(48px,7vw,96px) auto 0', padding: '0 clamp(24px,5vw,72px)' }}>
      ...
      <section style={{ padding: 'clamp(64px,8vw,120px) clamp(24px,5vw,72px) clamp(56px,7vw,96px)' }}>
